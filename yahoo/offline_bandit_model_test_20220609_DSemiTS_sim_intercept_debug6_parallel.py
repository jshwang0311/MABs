...
log_file = os.path.join(save_log_dir,'offline_model_test_prop_int_debug6_%s_%d.txt' % (time_mark, alg_idx))
...
with open('Results/iter_cumulative_reward_list_debug6_%s.pkl' % (log_file_ind), 'wb') as f:
    pickle.dump(iter_cumulative_reward_list, f)
with open('Results/iter_mean_reward_list_debug6_%s.pkl' % (log_file_ind), 'wb') as f:
    pickle.dump(iter_mean_reward_list, f)
with open('Results/iter_last_mean_reward_debug6_%s.pkl' % (log_file_ind), 'wb') as f:
