...
hyper_param_list=[0.01,0.03,0.05,0.06,0.1]
gamma = 0.1
lbd = 0.1
delta = 0.1
sigma = 0.01
...
algorithms.append(Discounted_LinUCB(n_user_features, n_item_features, gamma, lbd, delta, sigma, L, S, context="user", update_option = False))
algorithms.append(Discounted_LinUCB(n_user_features, n_item_features, gamma, lbd, delta, sigma, L, S, context="both", update_option = False))
algorithms.append(Discounted_LinUCB(n_user_features, n_item_features, gamma, lbd, delta, sigma, L, S, context="interaction", update_option = False))
...
for hyper_param in hyper_param_list:
    ...
    algorithms.append(LinUCB(n_user_features, n_item_features, hyper_param, "interaction", False))
...
for hyper_param in hyper_param_list:
    ...
    algorithms.append(LinearContextualThompsonSampling(n_user_features, n_item_features, hyper_param, "interaction", False))
...
for hyper_param in hyper_param_list:
    ...
    algorithms.append(Disjoint_LinUCB(n_user_features, n_item_features, n_arms, hyper_param, "interaction", False))

for hyper_param in hyper_param_list:
    algorithms.append(Disjoint_LinTS(n_user_features, n_item_features, n_arms, hyper_param, "user", False))
    algorithms.append(Disjoint_LinTS(n_user_features, n_item_features, n_arms, hyper_param, "both", False))
    algorithms.append(Disjoint_LinTS(n_user_features, n_item_features, n_arms, hyper_param, "interaction", False))
...
plt.legend(loc='best', bbox_to_anchor=(1, 0.5))
plt.savefig(os.path.join('Results','Best_CumulativeReward%s.png'%(time_mark)))
plt.show()
