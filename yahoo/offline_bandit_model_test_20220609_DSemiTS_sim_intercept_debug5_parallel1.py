...
with open('Results/iter_cumulative_reward_list_debug5_%s.pkl' % (log_file_ind), 'wb') as f:
    pickle.dump(iter_cumulative_reward_list, f)
with open('Results/iter_mean_reward_list_debug5_%s.pkl' % (log_file_ind), 'wb') as f:
    pickle.dump(iter_mean_reward_list, f)
with open('Results/iter_last_mean_reward_debug5_%s.pkl' % (log_file_ind), 'wb') as f:
