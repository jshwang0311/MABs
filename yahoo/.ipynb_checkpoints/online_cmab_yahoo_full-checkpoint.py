...
log_file = os.path.join(save_log_dir,'yahoo_CMAB_full.txt')
...
plt.savefig(os.path.join(save_fig_dir,'CMR_full.png'), bbox_inches='tight')
...
if not os.path.exists(save_fig_dir):
    os.makedirs(save_fig_dir)
plt.savefig(os.path.join(save_fig_dir,'CMR_sub_full.png'), bbox_inches='tight')