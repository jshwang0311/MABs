...
files = ("../data/R6/ydata-fp-td-clicks-v1_0.20090501","../data/R6/ydata-fp-td-clicks-v1_0.20090504","../data/R6/ydata-fp-td-clicks-v1_0.20090508","../data/R6/ydata-fp-td-clicks-v1_0.20090510")
...
log_file = os.path.join(save_log_dir,'offline_model_test_disjoint_prop_%s_small_v2.txt' % (time_mark))
...
with open('Results/Prop_disjoint_sim_mean_reward_list_%s_small_v2.pkl' % (time_mark), 'wb') as f:
    pickle.dump(mean_reward_list, f)

# Save MAB model
with open('model/Prop_disjoint_sim_R6A_CMABs_%s_small_v2.pkl' % (time_mark), 'wb') as f:
...
for alg_cate_idx in range(len(alg_cate_list)):
    ...
    #plt.show()
    plt.savefig(os.path.join('Results','Prop_disjoint_sim_%s_MeanReward%s_small_v2.png'%(alg_cate, time_mark)))
    plt.show()
...
plt.ylabel("Mean Reward")
plt.legend(loc='best', bbox_to_anchor=(1, 0.5))
plt.savefig(os.path.join('Results','Prop_disjoint_sim_Best_MeanReward%s_small_v2.png'%(time_mark)))
plt.show()
...
plt.legend(loc='best', bbox_to_anchor=(1, 0.5))
plt.savefig(os.path.join('Results','Prop_disjoint_sim_Best_CumulativeReward%s_small_v2.png'%(time_mark)))
plt.show()
