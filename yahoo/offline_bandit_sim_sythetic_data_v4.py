...
for i in range(1,5):
    ...
    sample_idx_num = int(len(change_model.coef_)*0.9)
    sample_idx = np.random.choice(np.arange(len(change_model.coef_)), sample_idx_num, replace=False)
    nonstationary = np.random.normal(0., max(initial_model.coef_)/1000, sample_idx_num)
...
with open('Results/linTS_cum_reward_sim_sythetic_data_v4.pkl', 'wb') as f:
    pickle.dump(cumulated_reward_linTS, f)
with open('Results/linTS_cum_regret_sim_sythetic_data_v4.pkl', 'wb') as f:
    pickle.dump(cumulated_regret_linTS, f)

with open('Results/DSemiTS_cum_reward_sim_sythetic_data_v4.pkl', 'wb') as f:
    pickle.dump(cumulated_reward_DSemiTS, f)
with open('Results/DSemiTS_cum_regret_sim_sythetic_data_v4.pkl', 'wb') as f:
    pickle.dump(cumulated_regret_DSemiTS, f)
    
with open('Results/DLinUCB_cum_reward_sim_sythetic_data_v4.pkl', 'wb') as f:
    pickle.dump(cumulated_reward_DLinUCB, f)
with open('Results/DLinUCB_cum_regret_sim_sythetic_data_v4.pkl', 'wb') as f:
    pickle.dump(cumulated_regret_DLinUCB, f)
    
with open('Results/SemiTS_cum_reward_sim_sythetic_data_v4.pkl', 'wb') as f:
    pickle.dump(cumulated_reward_SemiTS, f)
with open('Results/SemiTS_cum_regret_sim_sythetic_data_v4.pkl', 'wb') as f:
