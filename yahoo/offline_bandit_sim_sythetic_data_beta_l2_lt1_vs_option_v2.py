...
with open('Results/linTS_cum_reward_sim_sythetic_data_beta_l2_lt1_v2.pkl', 'wb') as f:
    pickle.dump(cumulated_reward_linTS, f)
with open('Results/linTS_cum_regret_sim_sythetic_data_beta_l2_lt1_v2.pkl', 'wb') as f:
    pickle.dump(cumulated_regret_linTS, f)

with open('Results/DSemiTS_cum_reward_sim_sythetic_data_beta_l2_lt1_v2.pkl', 'wb') as f:
    pickle.dump(cumulated_reward_DSemiTS, f)
with open('Results/DSemiTS_cum_regret_sim_sythetic_data_beta_l2_lt1_v2.pkl', 'wb') as f:
    pickle.dump(cumulated_regret_DSemiTS, f)
    
with open('Results/DLinUCB_cum_reward_sim_sythetic_data_beta_l2_lt1_v2.pkl', 'wb') as f:
    pickle.dump(cumulated_reward_DLinUCB, f)
with open('Results/DLinUCB_cum_regret_sim_sythetic_data_beta_l2_lt1_v2.pkl', 'wb') as f:
    pickle.dump(cumulated_regret_DLinUCB, f)
    
with open('Results/SemiTS_cum_reward_sim_sythetic_data_beta_l2_lt1_v2.pkl', 'wb') as f:
    pickle.dump(cumulated_reward_SemiTS, f)
with open('Results/SemiTS_cum_regret_sim_sythetic_data_beta_l2_lt1_v2.pkl', 'wb') as f:
